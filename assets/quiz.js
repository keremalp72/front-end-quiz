...
const questionContainer = document.querySelector(".quiz-text");
const selectionContainer = document.querySelector(".selections");
htmlBtn.addEventListener("click", htmlQuiz);
// cssBtn.addEventListener("click",cssQuiz);
// jsBtn.addEventListener("click",jsQuiz);
// acsbltyBtn.addEventListener("click",accesibilityQuiz);
function htmlQuiz() {
  const answerBtn = document.querySelector(".answerBtn")
  questionContainer.innerText = "";
  selectionContainer.innerText = "";
  questionContainer.innerHTML = ` <div class="quiz-questions">
        <p>Question <span id="place">6 </span>of 10</p>
        <h2 id="text-questions">Which of these color contrast ratios defines the minimum WCAG 2.1 Level AA requirement for normal text?</h2>
      </div> `;
      selectionContainer.innerHTML = ` <div class="selections">
        <button class="answerBtn"><img src="assets/images/html-img.svg" alt="">HTML</button>
        <button class="answerBtn"><img src="assets/images/css-img.svg" alt="">CSS</button>
        <button class="answerBtn"><img src="assets/images/js-img.svg" alt="">Javascript</button>
        <button class="answerBtn"><img src="assets/images/accessibility-image.svg" alt="">Accessibility</button>
      </div>`
